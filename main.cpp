...
void Action(Player &p, vector<Item> &v, MapTile m[][9])
{
    ...
    else if (c == 8)//attack
    {
        ...
        {
            Item I = v[2];
            //This is giving an error because baddies are not currently on map tiles
            // need to figure out how to say that map tile "has-a" baddie
            // Might need to not do it that way
            //attack(I, m.baddie);
        }
